...
echo $SudoPassword | sudo -S python3 WattsupPro.py -l -o gl3.log -p /dev/ttyUSB2 -t $LoggerDuration > /dev/null 2>&1 &
echo $SudoPassword | sudo -S python3 WattsupPro.py -l -o gl4.log -p /dev/ttyUSB1 -t $LoggerDuration > /dev/null 2>&1 &